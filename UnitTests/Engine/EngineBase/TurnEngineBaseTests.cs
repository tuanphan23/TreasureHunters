...
namespace UnitTests.Engine.EngineBase
{
    ...
    public class TurnEngineBaseTests
    {
        ...
        public void TurnEngine_ChooseToUseAbility_Valid_AlternateAbility_Should_Return_True()
        {
            ...
            CharacterPlayer.CurrentHealth = 1;
            CharacterPlayer.MaxHealth = 100;
            CharacterPlayer.AbilityTracker = new Dictionary<AbilityEnum, int>();
            CharacterPlayer.AbilityTracker.Add(AbilityEnum.Bandage, 1);
        ...
        [Test]
        public void TurnEngine_ChooseToUseAbility_InValid_Roll_1_No_Ability_Should_Return_False()
        {
            // Arrange
