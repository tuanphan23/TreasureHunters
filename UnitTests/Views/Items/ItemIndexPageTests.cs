...
namespace UnitTests.Views
{
    ...
    public class ItemIndexPageTests : ItemIndexPage
    {
        ...
        public void ItemIndexPage_OnItemSelected_Clicked_Default_Should_Pass()
        {
            ...
            // Act
            page.On_ItemClicked(null, selectedItemChangedEventArgs);
        ...
        [Test]
        public void ItemIndexPage_On_ItemClicked_Clicked_Null_Should_Return_Null()
        {
            // Arrange

            ImageButton img = new ImageButton();
            // Act
            page.On_ItemClicked(img, null);
        ...
        [Test]
        public void ItemIndexPage_On_ItemClicked_Clicked_Not_Null_Should_Pass()
        {
            // Arrange
