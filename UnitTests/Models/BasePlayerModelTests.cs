...
namespace UnitTests.Models
{
    ...
    public class BasePlayerModelTests
    {
        ...
        [Test]
        public void BasePlayerModel_GetPercentDefense_Default_Should_Pass()
        {
            // Arrange
            var data = new BasePlayerModel<CharacterModel>();
            var comp = (float)data.GetDefense() / 20;
            // Act
            float result = data.GetPercentDefense();
        ...
        public async Task BasePlayerModel_GetDamageRollValue_Default_Speed_Should_Pass()
        {
            ...
            // Assert
            Assert.AreEqual(2, result.DamageAmount);
        }
        ...
        [Test]
        public void BasePlayerModel_TriggerStatusEffect_Valid_Fire_Should_Pass()
        {
        ...
        [Test]
        public void BasePlayerModel_TriggerStatusEffect_Valid_Poison_Should_Pass()
        {
