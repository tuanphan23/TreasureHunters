        ...
        var datalist = new List<CharacterModel>()
            {
                ...
                new CharacterModel {
                    ...
                    Level = 1,
                    MaxHealth = 5,
                    ImageURI = "characterIcon2323.png",
                    Head = HeadString,
                    Necklass = NecklassString,
                    PrimaryHand = PrimaryHandString,
                    OffHand = OffHandString,
                ...
                new CharacterModel {
                    ...
                    Level = 1,
                    MaxHealth = 5,
                    ImageURI = "moreCharacterIcons34.png",
                    Head = HeadString,
                    Necklass = NecklassString,
                    PrimaryHand = PrimaryHandString,
                    OffHand = OffHandString,
